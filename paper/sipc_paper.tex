...
probatoire, puis l'appliquons à huit situations contrastées (détroit de Taïwan, guerre en
Ukraine, rivalité technologique États-Unis / Chine, mer de Chine méridionale, Arctique, Sahel,
Corée du Nord, gouvernance mondiale de l'IA). Nous
...
\section{Études de cas~: le détroit de Taïwan et un corpus de huit situations}
\label{sec:taiwan}
...
\paragraph{Un corpus de cas validés.} Au-delà de Taïwan, l'appareil a été appliqué à huit
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Sahel central} --- \emph{conversion d'un capital souverainiste}, les juntes
  transformant l'insécurité et un capital anti-occidental en légitimité de régime et en
  réalignement~;
  \item \textbf{Corée du Nord} --- \emph{conversion d'un capital nucléaire} en garantie de
  survie du régime, ce qui enracine un statut nucléaire de fait et borne le marchandage~;
  \item \textbf{gouvernance mondiale de l'intelligence artificielle} --- \emph{lutte de
  classement} sur les catégories et standards, dont la maîtrise oriente la gouvernance (l'IA y
  est l'objet analysé, non l'outil d'analyse).
\end{itemize}
...
Les huit études de cas de la \S\ref{sec:taiwan} existent ainsi sous forme d'objets JSON
...
outils de conformité gradués. Les huit études de cas --- détroit de Taïwan, guerre en Ukraine,
rivalité technologique États-Unis / Chine, mer de Chine méridionale, Arctique, Sahel, Corée du
Nord et gouvernance mondiale de l'IA --- suggèrent
