...
probatoire, puis l'appliquons à six situations contrastées (détroit de Taïwan, guerre en
Ukraine, rivalité technologique États-Unis / Chine, mer de Chine méridionale, Arctique, Sahel). Nous
...
\section{Études de cas~: le détroit de Taïwan et un corpus de six situations}
\label{sec:taiwan}
...
\paragraph{Un corpus de cas validés.} Au-delà de Taïwan, l'appareil a été appliqué à six
...
Les six études de cas de la \S\ref{sec:taiwan} existent ainsi sous forme d'objets JSON
...
outils de conformité gradués. Les six études de cas --- détroit de Taïwan, guerre en Ukraine,
rivalité technologique États-Unis / Chine, mer de Chine méridionale, Arctique et Sahel --- suggèrent
