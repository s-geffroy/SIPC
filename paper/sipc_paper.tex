...
probatoire, puis l'appliquons à sept situations contrastées (détroit de Taïwan, guerre en
...
\section{Études de cas~: le détroit de Taïwan et un corpus de sept situations}
\label{sec:taiwan}
...
\paragraph{Un corpus de cas validés.} Au-delà de Taïwan, l'appareil a été appliqué à sept
...
Les sept études de cas de la \S\ref{sec:taiwan} existent ainsi sous forme d'objets JSON
...
outils de conformité gradués. Les sept études de cas --- détroit de Taïwan, guerre en Ukraine,
rivalité technologique États-Unis / Chine, mer de Chine méridionale, Arctique, Sahel et Corée
du Nord --- suggèrent
