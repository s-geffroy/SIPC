...
probatoire, puis l'appliquons au cas du détroit de Taïwan. Nous discutons enfin ses limites,
notamment les risques d'anthropomorphisme, d'hypertrophie conceptuelle et de fausse précision.
...
\section{Étude de cas~: le détroit de Taïwan}
\label{sec:taiwan}
...
qu'un habillage~; ou que la dépendance technologique soit la variable décisive. Un signal
...
référentielle entre objets, et interdiction des scores non justifiés. Le cas de Taïwan de la
\S\ref{sec:taiwan} existe ainsi sous forme d'objet JSON validé et conforme à ces règles. C'est
cette vérifiabilité qui distingue la SIPC d'une grille purement discursive.
...
architecturale~: intégrer des héritages dispersés en un appareil cohérent et le rendre
\emph{testable}. L'étude du détroit de Taïwan suggère qu'un tel cadre peut hiérarchiser les
causes, expliciter les trajectoires et nommer ses propres conditions d'invalidation --- ce qui,
pour une sociologie appliquée des relations internationales, constitue déjà une exigence
salutaire.
