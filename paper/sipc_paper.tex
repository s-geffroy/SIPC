...
des sources gradées (profil \texttt{source\_profile}) et un suivi des signaux d'invalidation. Le
cas de Taïwan de la \S\ref{sec:taiwan} existe ainsi sous forme d'objet JSON validé au tier le
plus exigeant. C'est cette vérifiabilité qui distingue la SIPC d'une grille purement discursive.
