...
probatoire, puis l'appliquons à quatre situations contrastées (détroit de Taïwan, guerre en
Ukraine, rivalité technologique États-Unis / Chine, mer de Chine méridionale). Nous discutons
enfin ses limites, notamment les risques d'anthropomorphisme, d'hypertrophie conceptuelle et de
fausse précision.
...
\section{Études de cas~: le détroit de Taïwan et un corpus de quatre situations}
\label{sec:taiwan}
...
\paragraph{Un corpus de cas validés.} Au-delà de Taïwan, l'appareil a été appliqué à quatre
...
Les quatre études de cas de la \S\ref{sec:taiwan} existent ainsi sous forme d'objets JSON
...
outils de conformité gradués. Les quatre études de cas --- détroit de Taïwan, guerre en Ukraine,
rivalité technologique États-Unis / Chine et mer de Chine méridionale --- suggèrent qu'un tel
cadre peut hiérarchiser les causes, départager des hypothèses concurrentes, expliciter les
trajectoires et nommer ses propres conditions d'invalidation --- ce qui, pour une sociologie
