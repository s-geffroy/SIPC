...
Le fondement théorique et les huit études de cas sont exposés dans un papier académique
...
tier `VALIDATED`. Voir [Exemples](06_exemples/index.md).
...
6. [Exemples](06_exemples/index.md) — huit cas appliqués et validés.
